...
<p>คอลลาเจนเปปไทด์ ปลาคอดจากประเทศนอเวย์ เป็นคอลลาเจนเปปไทด์ที่ผลิตจากหนังปลาคอด จากประเทศนอร์เวย์ 
  ซึ่งเป็นแหล่งผลิตปลาคอดคุณภาพสูงแห่งหนึ่งของโลก ปลาคอดจากนอร์เวย์นั้นอาศัยอยู่ในน้ำทะเลที่สะอาดและอุดมไปด้วยแร่ธาตุ ส่งผลให้คอลลาเจนเปปไทด์จากปลาคอดจากประเทศนอร์เวย์นั้นมีคุณภาพสูง </p>
...
<p>หลักการทำงาน</p>
<p>ไฟเบอร์จากข้าวสาลี ทำงานโดยการเพิ่มกากใยอาหารในระบบทางเดินอาหาร99</p>
<p>สารอาหารที่ไม่ย่อยและไม่ดูดซึมเข้าสู่ร่างกาย แต่จะช่วยเพิ่มปริมาตรของอุจจาระและทำให้อุจจาระอ่อนนุ่มขึ้น ช่วยให้ขับถ่ายได้ง่ายขึ้น ไฟเบอร์จากข้าวสาลี มีเส้นใยอาหารชนิดไม่ละลายน้ำสูง
...
<p>หลักการทำงาน</p>
<p>L-Glutathione ทำงานโดยการจับกับอนุมูลอิสระและทำให้อนุมูลอิสระสูญเสียพลังงาน จึงไม่สามารถทำลายเซลล์ได้ และช่วยกระตุ้นการทำงานของเอนไซม์ต้านอนุมูลอิสระอื่นๆ
   ทำให้ร่างกายสามารถกำจัดอนุมูลอิสระได้อย่างมีประสิทธิภาพมากขึ้น</p>
<p>แหล่งที่มา </p>
<p>แอล-กลูตาไธโอนเป็นสารต้านอนุมูลอิสระที่พบได้ในทุกเซลล์ของร่างกาย  </p>
<p>แต่ปริมาณที่ผลิตได้อาจไม่เพียงพอต่อความต้องการในบางกรณี เช่น ผู้ที่มีอายุมากขึ้น ผู้ที่มีโรคบางชนิด เช่น โรคตับ โรคไต หรือโรคมะเร็ง และผู้ที่รับประทานอาหารที่มีกลูตาไธโอนต่ำ</p>
...
<p>• เพิ่มการไหลเวียนโลหิต ช่วยขยายหลอดเลือดและลดการเกาะตัวของเกล็ดเลือด ทำให้เลือดไหลเวียนได้ดีขึ้น ซึ่งส่งผลดีต่อสุขภาพโดยรวม 
  เช่น ช่วยลดความเสี่ยงในการเกิดโรคหัวใจ โรคหลอดเลือดสมอง โรคเบาหวาน และโรคอัลไซเมอร์ </p>
<p>• สารสกัดจากใบแปะก๊วยสามารถช่วยปกป้องเซลล์ประสาท ซึ่งอาจส่งผลดีต่อโรคที่เกี่ยวข้องกับระบบประสาท เช่น โรคอัลไซเมอร์โรคพาร์กินสัน และโรคหลอดเลือดสมอง</p>
<p>แหล่งที่มา</p>
<p>ใบแปะก๊วยมีถิ่นกำเนิดในจีนและญี่ปุ่น มีอายุยืนยาวกว่า 200 ล้านปี จึงได้รับการขนานนามว่าเป็น 
  ...
  โรคหลอดเลือดสมอง และโรคอัลไซเมอร์</p>
  <p>ในปัจจุบัน สารสกัดจากใบแปะก๊วยสามารถใช้เป็นยารักษาโรคความจำเสื่อม </p>
...
<p>แหล่งที่มาของวิตามินบี2 </p>
<p>• อาหารจำพวกนมและผลิตภัณฑ์จากนม เช่น นม โยเกิร์ต ชีส</p>
<p>• อาหารจำพวกเนื้อสัตว์ เช่น เนื้อวัว เนื้อหมู เนื้อไก่ ตับ</p>
<p>• อาหารจำพวกไข่ </p>
<p>• อาหารจำพวกถั่วเมล็ดแห้ง เช่น ถั่วเหลือง ถั่วลิสง ถั่วเขียว ถั่วแดง• 
...
<p>ช่วยการทำงานของเซลล์เม็ดเลือดขาวอย่างมีประสิทธิภาพ</p>
<p>ช่วยเปลี่ยนโปรตีน คาร์โบไฮเดรต และไขมันให้เป็นพลังงาน  </p>
<p>ช่วยป้องกันอาการคลื่นไส้และอาเจียน</p>
<p>ช่วยรักษาผิวพรรณให้แข็งแรง โดยช่วยกระตุ้นการสร้างคอลลาเจน 
